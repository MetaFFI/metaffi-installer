...
for plugindir in os.listdir(metaffi_home):
	...
	# if windows 'uninstall_plugin.exe', otherwise 'uninstall_plugin'
	if platform.system() == 'Windows':
		uninstall_script_path = os.path.join(metaffi_home, plugindir, 'uninstall_plugin.exe')
	else:
		uninstall_script_path = os.path.join(metaffi_home, plugindir, 'uninstall_plugin')
